...
{_section("已选前台窗口记录", bundle.app_sessions)}
{_section("已选剪贴板素材", bundle.clipboard_items)}
{_section("已选浏览/搜索记录", bundle.browser_items)}
{_section("已选 AI 提问记录", bundle.ai_prompts)}
